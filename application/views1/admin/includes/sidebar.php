              ...
              <ul class="metismenu" id="side-menu">
                  ...
                  <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="<?=site_url('admin/bookings/upcoming')?>">Upcoming</a></li>
                          <li><a href="<?=site_url('admin/bookings/completed')?>">Completed</a></li>
                          <li><a href="<?=site_url('admin/bookings/cancelled')?>">Cancelled</a></li>
                      </ul>
                  </li>
                  <li>
                  ...
                  <li>
                      <a href="#"><i class="fa fa-shower"></i> <span> Amenities </span> <span class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="<?=site_url('admin/amenities')?>">Amenities</a></li>
                          <li><a href="<?=site_url('admin/amenities/add')?>">Add amenity</a></li>
                      </ul>
                  </li>
                  ...
                  <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="<?=site_url('admin/customers')?>">View customers</a></li>
                          <li><a href="<?=site_url('admin/customers/add')?>">Add customer</a></li>
                      </ul>
                  </li>

                  <li>
                      <a href="#"><i class="fa fa-user-secret"></i> <span> Turf owners </span> <span class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="<?=site_url('admin/owners')?>">View owners</a></li>
                          <li><a href="<?=site_url('admin/owners/add')?>">Add owner</a></li>
                      </ul>
                  </li>
                  ...
                  <li>
                      <a href="#"><i class="fa fa-image"></i> <span> Banners </span> <span class="menu-arrow"></span></a>
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="<?=site_url('admin/banners')?>">View banners</a></li>
                          <li><a href="<?=site_url('admin/banners/add')?>">Add banner</a></li>
                      </ul>
                  </li>
