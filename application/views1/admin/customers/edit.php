...
<html>
      ...
      <div class="content-page">
        <div class="content">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('admin/customers/editCustomer')?>" method="post" id="edit-form">
                      ...
                      <div class="col-md-8">
                          <div class="">
                              <div>
                                  ...
                                  <input type="text" maxlength="50" name="username" class="form-control" value="<?=$user->username?>" required>
                              </div>
                              <div>
                              ...
                              <div>
                                  ...
                                  <input type="email" maxlength="100" name="email" id="em" value="<?=$user->email?>" class="form-control" required>
                              ...
                              <div>
                                  ...
                                  <select class="form-control" name="status">
                                    <option value="1" <?php if($user->status){?>selected<?php } ?>>Active</option>
                                    <option value="0" <?php if(!$user->status){?>selected<?php } ?>>Blocked</option>
                                  </select>
                                  <!-- <input class="sample_input" type="hidden" name="test[image]"> -->
                              </div>
  ...
  $('#edit-form').on('submit', function(e){
    ...
    if (isNaN(mobile) || mobile.length != 10) {
      ...
      $.ajax({
          method: "POST",
          url: "<?php echo site_url('admin/customers/validationEdit');?>",
          dataType : "json",
          data : { mobile : mobile , email : email , user_id : user_id },
