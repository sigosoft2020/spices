...
<html>
      ...
      <div class="content-page">
        <div class="content">
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">EDIT OWNER</h4>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('admin/owners/editOwner')?>" method="post" id="edit-form">

                  <input type="hidden" name="owner_id" id="owner_id" value="<?=$owner->owner_id?>">
                  <div class="row">
                      <div class="col-md-8">
                          <div class="">
                              <div>
                                  ...
                                  <input type="text" maxlength="50" name="username" class="form-control" value="<?=$owner->username?>" required>
                              </div>
                              <div>
                                  ...
                                  <input type="text" maxlength="10" name="mobile" id="mo" value="<?=$owner->mobile?>" class="form-control" required>
                              ...
                              <div>
                                  ...
                                  <input type="email" maxlength="100" name="email" id="em" value="<?=$owner->email?>" class="form-control" required>
                              ...
                              <div>
                                  ...
                                  <select class="form-control" name="status">
                                    <option value="1" <?php if($owner->status){?>selected<?php } ?>>Active</option>
                                    <option value="0" <?php if(!$owner->status){?>selected<?php } ?>>Blocked</option>
                                  </select>
                                  <!-- <input class="sample_input" type="hidden" name="test[image]"> -->
                              </div>
                      ...
                      <div class="col-md-4">
                        <div id="current-image">
                          <img src="<?=base_url() . $owner->image?>" height="192px" width="192px">
                        </div>
  ...
  $('#edit-form').on('submit', function(e){
    ...
    if (isNaN(mobile) || mobile.length != 10) {
      ...
      $.ajax({
          method: "POST",
          url: "<?php echo site_url('admin/owners/validationEdit');?>",
          dataType : "json",
          data : { mobile : mobile , email : email , owner_id : owner_id },
