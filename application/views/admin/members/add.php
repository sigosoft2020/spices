...
<html>
      ...
      <div class="content-page">
        <div class="content">
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">ADD MEMBER</h4>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('admin/members/addmember')?>" method="post" id="add-form">
                          ...
                          <div class="">
                              <div>
                                  ...
                                  <p class="text-muted font-14">
                                        (Enter member name here , eg: John samuel)
                                  </p>
  ...
  $('#add-form').on('submit', function(e){
    ...
    if (isNaN(mobile) || mobile.length != 10) {
      ...
      $.ajax({
          method: "POST",
          url: "<?php echo site_url('admin/members/validation');?>",
          dataType : "json",
