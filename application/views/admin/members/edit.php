...
<html>
      ...
      <div class="content-page">
        <div class="content">
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">EDIT MEMBER</h4>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('admin/members/editmember')?>" method="post" id="edit-form">
                  ...
                  <div class="row">
                      <div class="col-md-8">
                          <div class="">
                              <div>
                                  <p class="mb-1 mt-4 font-weight-bold">Member name <span style="color:red">*</span></p>
                                  <p class="text-muted font-14">
                                        (Enter customer name here , eg: John samuel)
                                  </p>
                                  <input type="text" maxlength="50" name="username" class="form-control" value="<?=$member->username?>" required>
                              </div>
                              <div>
                                  ...
                                  <input type="text" maxlength="10" name="mobile" id="mo" value="<?=$member->mobile?>" class="form-control" required>
                              ...
                              <div>
                                  ...
                                  <input type="email" maxlength="100" name="email" id="em" value="<?=$member->email?>" class="form-control" required>
                              ...
                              <div>
                                  ...
                                  <p class="text-muted font-14">
                                        (Activate or deactivate customer , if you deactivate this customer he cannot login to android app..!);
                                  </p>
                                  <select class="form-control" name="status">
                                    <option value="1" <?php if($member->status){?>selected<?php } ?>>Active</option>
                                    <option value="0" <?php if(!$member->status){?>selected<?php } ?>>Blocked</option>
                                  </select>
                                  <!-- <input class="sample_input" type="hidden" name="test[image]"> -->
                              </div>
                      ...
                      <div class="col-md-4">
                        <div id="current-image">
                          <img src="<?=base_url() . $member->image?>" height="192px" width="192px">
                        </div>
  ...
  $('#edit-form').on('submit', function(e){
    ...
    if (isNaN(mobile) || mobile.length != 10) {
      ...
      $.ajax({
          method: "POST",
          url: "<?php echo site_url('admin/members/validationEdit');?>",
          dataType : "json",
          data : { mobile : mobile , email : email , member_id : member_id },
