                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                      <div class="form-group">
                        ...
                        <!--<input type="date" class="form-control" id="datepicker3" name="start_date">-->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="datepicker4" name="end_date" value="<?=date('Y-m-d')?>">
                        <!--<input type="date" class="form-control" id="datepicker4" name="end_date">-->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <div class="input-group">
                              <input id="timepicker" type="text" name="start_time" class="form-control" readonly>
                          </div>
